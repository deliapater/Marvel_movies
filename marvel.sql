...
-- 3.  Oops! Someone at CodeClan spelled Kimberly's name wrong! Change it to reflect the
-- proper spelling ('Kimberly Clarke' should be 'Kimberly Clark').
UPDATE people SET name = 'Kimberly Clark' WHERE name = 'Kimberly Clarke';

-- 4.  Return ONLY your name from the 'people' table.
SELECT * FROM people WHERE name = 'Delia Paternina';

-- 5.  The cinema is showing 'Batman Begins', but Batman is DC, not Marvel! Delete the entry
...
-- 9.  The cinema would also like to make the Guardians movies a back to back feature. Find out the show
-- time of "Guardians of the Galaxy" and set the show time of "Guardians of the Galaxy 2" to start two hours
-- later.
